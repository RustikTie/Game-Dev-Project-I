...
bool j1Scene::Start()
{
	if (start)
	{
		if (previousScene == CREDITS)
		{
			...
			QuitButton = App->gui->AddButton(400, 200, BUTTON, rect_quit, "QUIT");
			rect_start = { 484, 3151, 365, 185 };
			StartButton = App->gui->AddButton(400, 100, BUTTON, rect_quit, "START");
			rect_options = { 868, 3151, 365, 185 };
			Options = App->gui->AddButton(400, 300, BUTTON, rect_quit, "OPTIONS");
